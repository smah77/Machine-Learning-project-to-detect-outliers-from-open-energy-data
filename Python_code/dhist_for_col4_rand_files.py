...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr 13 00:51:55 2020
...
with open("month_lof/dhist_for_rand_col4_data.csv", "w") as f05:
    ...
    for filename in all_files:
        ...
        test_data1=[values for values in df.iloc[train_len:, 0:3].values]
        
        test_data2=[values for values in df2.iloc[:, 3:4].values]
