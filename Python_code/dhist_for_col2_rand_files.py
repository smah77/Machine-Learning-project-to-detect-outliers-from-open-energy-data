...
# -*- coding: utf-8 -*-
"""
Created on Sun Apr 12 23:51:35 2020
...
with open("month_lof/dhist_for_rand_col2_data.csv", "w") as f05:
    ...
    for filename in all_files:
        ...
        test_data1=[values for values in df.iloc[train_len:, 0:1].values]
        
        test_data2=[values for values in df2.iloc[:, 1:2].values]
    
        test_data3=[values for values in df.iloc[train_len:, 2:columns].values]
        ...
        for i in range(len(test_data3)):
            ...
            ll3.append(test_data3[i][0])
            ll4.append(test_data3[i][1])
